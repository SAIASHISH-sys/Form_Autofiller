          ...
          <div className="space-y-5">
            ...
            <form className="space-y-4" onSubmit={handleRegister}>
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-2.5 bg-linear-to-r from-violet-600 to-indigo-600 text-white rounded-xl font-semibold hover:from-violet-500 hover:to-indigo-500 active:scale-[0.98] transition-all text-sm flex items-center justify-center gap-2 group shadow-lg shadow-violet-500/20 disabled:opacity-50"
              >
